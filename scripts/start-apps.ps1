...
Start-App 'payment-stable' 'apps/payment-service/target/payment-service-1.0.0-SNAPSHOT.jar' @('--server.port=8081','--app.version=stable-v1','--app.fault-mode=HEALTHY')
Start-App 'payment-candidate' 'apps/payment-service/target/payment-service-1.0.0-SNAPSHOT.jar' @('--server.port=8082','--app.version=candidate-v2','--app.fault-mode=HEALTHY')
